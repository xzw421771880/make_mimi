...
//        textTheme: TextTheme(subtitle: "充币"),
  ...
  Widget buildCell(int index){
    ...
    if(widget.user['idCardNum'] == null){
      ...
      idCard = str.substring(0,1) +'******' + str.substring(str.length - 1,str.length);
    }
    ...
    List detailList = [name,idCard,phone,widget.user['qq'],widget.user['sex'],widget.user['ageBracket'],tb == null?'': tb['taobao_name'],tb == null?'': tb['taobao_level'],tb == null?'': tb['taobao_sex'],tb == null?'': tb['taobao_name'],tb == null?'': tb['province']+tb['city']+tb['district']+tb['detailed_address']];
